...
| **frontend-test-executor** | "test frontend", "execute frontend test plan", "run frontend tests", "check UI", "launch the app", "verify the frontend", "test the app", or any simulator/testing request. | **RED/GREEN gate skill** — boots iOS simulator, starts Expo, opens app in Expo Go. Must run BEFORE any frontend testing. |
