...
**All agents must **strictly** follow the output format below without any deviation, omission, or improvisation.** The response **must** be exactly as specified, including headings, code fences, and placeholder markers. Any variation will be considered non‑compliant.
